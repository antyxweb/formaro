...
/** @var array $arResult */
$activeKey = 'news';
$pageTitle = 'Новости — Formaro Partner';
...
<div class="filter-bar d-flex flex-wrap gap-2 align-items-end justify-content-between">
    <div class="d-flex flex-wrap gap-2 align-items-end">
        <div><label class="form-label small mb-1">Поиск по заголовку</label>
            <input type="text" class="form-control" id="qInput" placeholder="Например: акция" style="min-width:220px;"></div>
    ...
    <a href="<?= $arResult['SEF_FOLDER'] ?>news/edit/new/" class="btn btn-success"><svg class="ic-inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"></path><path d="M12 5v14"></path></svg> Добавить новость</a>
</div>

<div class="card">
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table mb-0 align-middle" id="newsTable">
                <thead><tr>
                    <th class="row-check"><input type="checkbox" class="form-check-input" id="checkAll"></th>
                    <th>Заголовок</th><th>Статус</th><th>Дата</th><th class="text-end">Действия</th>
                </tr></thead>
                <tbody id="newsBody"><tr><td colspan="5" class="text-center text-muted-2 py-4">Загрузка…</td></tr></tbody>
            </table>
        </div>
