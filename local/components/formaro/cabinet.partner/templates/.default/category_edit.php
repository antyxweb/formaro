...
?>
<a href="<?= $arResult['SEF_FOLDER'] ?>categories/" class="btn btn-link px-0 mb-2"><i class="bi bi-arrow-left"></i> К списку категорий</a>
...
<div class="card">
    ...
    <div class="detail-actionbar">
        ...
        <a href="<?= $arResult['SEF_FOLDER'] ?>categories/" class="btn btn-light"><svg class="ic-inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg> Отмена</a>
...
<?php
$pageScripts = ['category-detail.js'];
