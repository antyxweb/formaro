/* Порт cabinet-html/assets/js/categories.js — логика не менялась, только
   ссылки вместо *.html теперь строятся из CABINET_BOOTSTRAP.cabinetUrl
   (SEF-роуты компонента). */
