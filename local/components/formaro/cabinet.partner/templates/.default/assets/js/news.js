/* Порт cabinet-html/assets/js/news.js — ссылки на *.html заменены на
   SEF-роуты, dsSave(whole-array) заменён на saveOwnRows (diff-aware).
   Новости партнёра сервер уже отдаёт отфильтрованными (PROPERTY_PARTNER_ID),
   ownOnly() — как и в orders.js, не более чем безопасная подстраховка. */
...
$(function () {
    ...
    $('#bulkDeleteBtn').on('click', function () {
        ...
        showConfirm('Удалить выбранные новости (' + ids.length + ')?', function () {
            ...
            saveOwnRows('news', null, allNews, function () {
