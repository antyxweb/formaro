...
?>
<a href="<?= $arResult['SEF_FOLDER'] ?>news/" class="btn btn-link px-0 mb-2"><i class="bi bi-arrow-left"></i> К списку новостей</a>
...
<div class="card">
        ...
        <form id="newsForm" onsubmit="return false;">
            ...
            <div class="row">
                <div class="col-md-5 mb-3">
                    ...
                    <input type="text" class="form-control" id="f_title" required maxlength="200" data-validate="text">
                </div>
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="f_datetime" placeholder="дд.мм.гггг чч:мм" autocomplete="off">
                </div>
                <div class="col-md-2 mb-3">
    ...
    <div class="detail-actionbar">
        ...
        <a href="<?= $arResult['SEF_FOLDER'] ?>news/" class="btn btn-light"><svg class="ic-inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg> Отмена</a>
