...
function renderProducts() {
    ...
    var rows = allProducts.filter(function (p) {
        ...
        if (catId) {
            // товар должен попадать в саму категорию ИЛИ в любую из её подкатегорий —
            // иначе при фильтре по родительскому разделу пропадали бы товары из вложенных
...
function renderPage(rows) {
    ...
    rows.forEach(function (p) {
        $t.append(
            ...
            '<td><a href="product-detail.html?id=' + p.id + '">' + esc(p.name) + '</a></td>' +
            ...
            '<td class="text-end">' +
              '<a class="btn btn-sm btn-outline-secondary" href="product-detail.html?id=' + p.id + '" title="Редактировать"><svg class="ic-inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"></path><path d="m15 5 4 4"></path></svg></a> ' +
              '<a class="btn btn-sm btn-outline-secondary" href="preview.html?type=product&id=' + p.id + '" target="_blank" title="Предпросмотр на сайте"><svg class="ic-inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6"></path><path d="M10 14 21 3"></path><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path></svg></a> ' +
